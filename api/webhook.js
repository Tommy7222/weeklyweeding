      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:white;padding:40px;border-radius:0 0 12px 12px;border:1px solid #eee;">
            ...
            <p style="color:#444;line-height:1.6;">Your payment was confirmed and your subscription is active. We'll reach out within <strong>24 hours</strong> to schedule your initial clean-up and first visit.</p>
        ...
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:white;padding:32px;border:1px solid #eee;border-radius:0 0 12px 12px;">
            ...
            <div style="margin-top:24px;padding:16px;background:#e8f5e9;border-radius:8px;">
              <p style="margin:0;color:#1B5E20;font-size:14px;">Next step: Send service agreement via SignWell and schedule first visit!</p>
            </div>
          </div>
        </div>
      `
